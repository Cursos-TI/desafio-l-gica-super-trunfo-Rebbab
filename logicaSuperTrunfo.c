...
// Tema 3
// Segue com as mesmas limitações do anterior mas agora tem o menu e a logica de comparação utilizando if e else.
// esse é do nivel intermediario
...
void comparacao(){
    ...
    printf("3 - Populacao da cidade \n");
    printf("4 - Quantidade de pontos turisticos na cidade \n");
